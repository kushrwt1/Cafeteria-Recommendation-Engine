...
class FeedbackRepository {
    ...
    getFeedbackById(id) {
        return __awaiter(this, void 0, void 0, function* () {
            const [rows] = yield database_1.db.execute("SELECT * FROM Feedback WHERE id = ?", [
                id,
            ]);
    ...
    addFeedback(feedback) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield database_1.db.execute("INSERT INTO Feedback (comment, rating, menu_item_id, user_id, date) VALUES (?, ?, ?, ?, ?)", [
                    feedback.comment,
                    feedback.rating,
    ...
    updateFeedback(feedback) {
        return __awaiter(this, void 0, void 0, function* () {
            yield database_1.db.execute("UPDATE Feedback SET comment = ?, rating = ?, menu_item_id = ?, user_id = ?, date = ? WHERE id = ?", [
                feedback.comment,
                feedback.rating,
                feedback.menu_item_id,
                feedback.user_id,
